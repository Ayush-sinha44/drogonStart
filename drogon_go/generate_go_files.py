...
gen_dir = "/home/ayush/Projects/drogon_go/internal/generator"

filter_go = """package generator
...
controller_go = """package generator
...
with open(f"{gen_dir}/filter.go", "w") as f:
    f.write(filter_go)

with open(f"{gen_dir}/plugin.go", "w") as f:
    f.write(plugin_go)

with open(f"{gen_dir}/controller.go", "w") as f:
    f.write(controller_go)

with open(f"{gen_dir}/project.go", "w") as f:
    f.write(project_go)
